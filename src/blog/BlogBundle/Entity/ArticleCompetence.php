<?php
// src/blog/BlogBundle/Entity/ArticleCompetence.php
...
class ArticleCompetence
{
  /**
   * @ORM\Id
   * @ORM\ManyToOne(targetEntity="blog\BlogBundle\Entity\Article", inversedBy="articleCompetences")
   */
  private $article;

  /**
   * @ORM\Id
   * @ORM\ManyToOne(targetEntity="blog\BlogBundle\Entity\Competence")
   */
  private $competence;
