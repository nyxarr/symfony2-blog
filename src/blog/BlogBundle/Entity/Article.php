<?php
// src/blog/BlogBundle/Entity/Article.php
...
class Article
{
  ...
  /**
   * @ORM\OneToOne(targetEntity="blog\BlogBundle\Entity\Image", cascade={"persist", "remove"})
   */
  private $image;

  /**
   * @ORM\ManyToMany(targetEntity="blog\BlogBundle\Entity\Categorie", cascade={"persist"})
  ...
  /**
   * @ORM\OneToMany(targetEntity="blog\BlogBundle\Entity\ArticleCompetence", mappedBy="article")
   */
